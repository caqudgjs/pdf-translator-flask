...
class OptimizedPDFTranslator {
    ...
    async handleSubmit(e) {
        ...
        try {
            // 최적화된 번역 요청
            const response = await fetch('/api/pdf/optimized/translate', {
                method: 'POST',
                body: formData
            });
    ...
    showLoading() {
        ...
        this.loadingMessage.textContent = 'PDF를 번역하고 있습니다... (최적화된 처리)';
    }
